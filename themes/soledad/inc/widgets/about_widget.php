...
class penci_about_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<div class="about-widget<?php if( $align ): echo ' ' . $align; endif; ?>">
			<?php if ( $image ) : ?>
				<?php echo $open_image; ?><img src="<?php echo esc_url( $image ); ?>" alt="<?php echo esc_attr( $title ); ?>"<?php echo $circle_style; ?>/><?php echo $close_image; ?>
			<?php endif; ?>
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => 'About Me', 'align' => '', 'image' => '', 'circle' => '', 'imageurl' => '', 'target' => '', 'heading' => '', 'description' => '' );
