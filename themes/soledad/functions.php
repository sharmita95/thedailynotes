...
if ( ! function_exists( 'penci_load_scripts' ) ) {
	...
	function penci_load_scripts() {
		...
		// Enqueue style
		wp_enqueue_style( 'penci_style', get_stylesheet_directory_uri() . '/style.css', array(), '3.2' );

		// Enqueue script
		wp_enqueue_script( 'libs-js', get_template_directory_uri() . '/js/libs-script.min.js', array( 'jquery' ), '3.2', true );
		...
		wp_enqueue_script( 'main-scripts', get_template_directory_uri() . '/js/main.js', array( 'jquery' ), '3.2', true );
		wp_enqueue_script( 'penci_ajax_like_post', get_template_directory_uri() . '/js/post-like.js', array( 'jquery' ), '3.2', true );
